...
2. **No live LLM or web calls in unit tests.** Every external provider (Kalshi, MLB Stats API, Anthropic) must be mocked/injected. The suite must run offline and without credentials.
