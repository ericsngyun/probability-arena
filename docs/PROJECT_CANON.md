...
| crypto_horizon_cohorts, crypto_horizon_cohort_members, crypto_horizon_observations | Crypto horizon-observation lane (CRYPTO-HORIZON-OBS-001; bounded MANUAL market/liquidity observation of a frozen cohort near lifecycle horizons via DexScreener — no timer/loop/autonomy, zero SolanaTracker impact; misses recorded honestly, never a trade signal) |
