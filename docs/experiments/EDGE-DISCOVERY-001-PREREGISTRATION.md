...
### D-3 — E4 excludes crossed quotes (`close_ask < close_bid`) (2026-08-15, pre-results)
...
### D-4 — E4 adopts Corollary 19's abstain band as the primary trade filter (2026-08-15, pre-results)
...
### D-5 — E4 declares the fee block size `C = 100` contracts (2026-08-15, pre-results)
...
### D-6 — E4 scale convention (2026-08-15, pre-results, specification not departure)
